/*(function ($) {
  $(document).ready(function () {
    ...
    $("#pais_prov li").each(function () {
      var elemento_selected = $(this).attr("elemento-seleccionado");
      var pais_id = $(this).attr("pais-id")
      if (elemento_selected == 1) {
        $("#pais").val(pais_id).trigger('change');//me dice que cuando cambien pais, se dispara a la siguiete funcion
        window.id_pais_seleccionado = pais_id;
        ...
        $("#provincia").val($(this).attr("provincia-id"))
        $(".ocultar").show();
